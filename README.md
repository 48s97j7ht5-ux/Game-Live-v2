...
Сейчас в станке не болванка, а готовая человеческая модель Michelle (Mixamo / three.js), рост ~200 px, до 48 цветов, камера спереди. Если снова спина — в Run workflow поставь yaw `180`.
