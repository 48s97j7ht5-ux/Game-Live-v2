...
На станке две отдельные болванки (кнопки **глина** / **аниме**):

- **глина** — MakeHuman hm08, CC0, морфы груди/живота/бёдер/попы.
- **аниме** — шаблоны [MB-Lab](https://github.com/animate1978/MB-Lab) F_AN01 / F_AN02 / M_AN01. Другая сетка, морфы глины на неё не ставятся. Меши **AGPL-3.0** (`models/mblab/NOTICE`).

Это не морф «сделать аниме из hm08»: у аниме своя топология и своя библиотека персонажей.
